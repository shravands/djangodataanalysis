...
def eda_csv(file_name, host_val):
    ...
    profile = pandas_profiling.ProfileReport(df, title='Data profile', explorative=True)
    folder = 'eda_profile/'
    profile_file = profile.to_file('media/eda_folder/'+output_file_name)
    ...
    result['profile_link'] = {'file_path':'http://'+host_val+'/media/eda_folder/'+output_file_name}
